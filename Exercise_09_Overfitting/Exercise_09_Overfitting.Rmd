...
```{r fitting model on the training set}
...
```{r comparing training set results 1}
...
```{r comparing training set results 2}
...
```{r fit backward regression, results='hide'}
...
```{r compare backward regression training}
...
```{r compare backward regression test set}
